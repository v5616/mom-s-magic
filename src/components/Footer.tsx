          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center">
              <img
                ...
                alt="MomMagic Logo"
              />
              <span className="ml-2 text-xl font-display font-bold text-white">MomMagic</span>
            </div>
            <p className="mt-4 text-sm text-gray-300">
              Bringing the warmth of homemade food to every plate and empowering every mom to become a chef-preneur.
            </p>
