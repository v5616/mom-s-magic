...
const DashboardPage: React.FC = () => {
  ...
  const userData = {
    ...
    orders: [
      { id: 'ORD123456', date: '2023-06-10', status: 'Delivered', amount: 149 },
      { id: 'ORD123455', date: '2023-06-09', status: 'Delivered', amount: 149 },
      { id: 'ORD123454', date: '2023-06-08', status: 'Delivered', amount: 149 },
      { id: 'ORD123453', date: '2023-06-07', status: 'Delivered', amount: 149 },
      { id: 'ORD123452', date: '2023-06-06', status: 'Delivered', amount: 149 },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
            <h3 className="text-2xl leading-6 font-bold text-gray-900">Dashboard</h3>
