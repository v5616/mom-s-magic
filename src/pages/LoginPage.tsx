...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real application, you would validate and send this data to your backend
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M16.365 1.43c0.464-0.557 0.755-1.225 0.281-1.916-0.474-0.691-1.305-0.501-1.951-0.156-0.646 0.347-1.388 1.084-1.306 1.837 0.082 0.753 0.814 0.918 1.458 0.731 0.645-0.187 1.058-0.494 1.517-0.494v0zM15.931 3.1c-1.856 0.365-3.178 1.89-3.178 3.775 0 2.023 1.45 3.772 3.385 4.129-0.352 1.235-0.62 1.782-1.19 2.891-0.422 0.813-1.035 1.793-1.764 1.793-0.729 0-0.962-0.778-1.806-0.778-0.844 0-1.097 0.795-1.819 0.795-0.722 0-1.27-0.814-1.782-1.793-0.978-1.891-1.73-5.277-1.73-7.561 0-4.162 2.705-6.351 5.365-6.351 1.419 0 2.582 0.938 3.352 0.938 0.77 0 1.971-1 3.32-1 0.587 0 2.59 0.088 3.927 2.082-3.177 1.891-2.383 5.827 0.26 6.979-0.6 1.396-1.092 1.825-1.336 2.103z" />
                    </svg>
                  </a>
                </div>
              </div>
